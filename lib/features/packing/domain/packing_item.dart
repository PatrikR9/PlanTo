...
const Map<String, String> _labels = <String, String>{
  // --- rozšíření aktivit, 21. 8. ---
  'pack.fishing_licence': 'Rybářský lístek a povolenka',
  'pack.fishing_rod': 'Prut a náčiní',
  'pack.mushroom_basket': 'Košík a nůž na houby',
  'pack.binoculars': 'Dalekohled',
  'pack.star_map': 'Mapa oblohy nebo aplikace',
  'pack.red_light': 'Červené světlo, neoslní oči',
  'pack.picnic_blanket': 'Deka na sezení',
  'pack.cutlery': 'Příbor, kelímky, otvírák',
  'pack.riding_helmet': 'Jezdecká přilba',
  'pack.long_trousers': 'Dlouhé kalhoty',
  'pack.grip_gloves': 'Rukavice s úchopem',
  'pack.ferrata_set': 'Ferratový set a přilba',
  'pack.running_shoes': 'Běžecké boty',
  'pack.diving_card': 'Potápěčský průkaz a logbook',
  'pack.wetsuit': 'Neopren',
  'pack.boat_shoes': 'Boty na loď se světlou podrážkou',
  'pack.seasickness': 'Něco na mořskou nemoc',
  'pack.waterproof_case': 'Vodotěsné pouzdro na telefon',
  'pack.sled': 'Boby nebo sáňky',
  'pack.snowshoes': 'Sněžnice',
  'pack.avalanche_kit': 'Lavinový set: vyhledávač, sonda, lopata',
  'pack.skins': 'Pásy a harscheisen',
  'pack.hand_warmers': 'Ohřívače rukou',
  'pack.mug_deposit': 'Drobné na zálohu za hrnek',
  'pack.notebook': 'Zápisník nebo poznámky v telefonu',
  'pack.camera': 'Foťák',
  'pack.grill_tools': 'Náčiní na gril',
  'pack.charcoal': 'Uhlí a podpalovač',
  'pack.wet_wipes': 'Vlhčené ubrousky',
  'pack.kids_snack': 'Svačina pro děti',
  'pack.kids_spare_clothes': 'Náhradní oblečení pro děti',
  'pack.board_game': 'Deskovka',
  'pack.bowling_socks': 'Ponožky na bowling',
  'pack.swim_goggles': 'Plavecké brýle',
...
const Map<String, String> _reasons = <String, String>{
  // --- rozšíření aktivit, 21. 8. ---
  'reason.activity_fishing': 'Na ryby',
  'reason.activity_mushrooming': 'Na houby',
  'reason.activity_stargazing': 'Na hvězdy',
  'reason.activity_picnic': 'Na piknik',
  'reason.activity_riding': 'Na koně',
  'reason.activity_ferrata': 'Na ferratu',
  'reason.activity_running': 'Na běh',
  'reason.activity_diving': 'Na potápění',
  'reason.activity_sailing': 'Na loď',
  'reason.activity_paddleboard': 'Na paddleboard',
  'reason.activity_snow_fun': 'Na sníh',
  'reason.activity_ski_touring': 'Na skialp',
  'reason.activity_christmas_market': 'Na vánoční trhy',
  'reason.activity_culture': 'Na prohlídku',
  'reason.activity_food': 'Na ochutnávku',
  'reason.activity_bbq': 'Na gril',
  'reason.activity_kids': 'S dětmi',
  'reason.activity_indoor_game': 'Na hru',
  'reason.avalanche_terrain': 'Volný terén, laviny',
  'reason.dark_early': 'Brzy se stmívá',
  'reason.photos_worth_it': 'Bude co fotit',
  'reason.pool_rules': 'Bazén to vyžaduje',
